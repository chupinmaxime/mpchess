...
\commande|show_possible_moves(«square»)|\index{show_possible_moves@\lstinline+set_possible_moves+}\smallskip
...
\commande|show_possible_moves_step(«step»)(«square»)|\index{show_possible_moves_step@\lstinline+set_possible_moves_step+}\smallskip
...
\begin{description}
\item[v0.3, April 6, 2023:] Corrections in the documentation, especially the
