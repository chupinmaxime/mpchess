...
façons (ajout de pièces une à une, lecteur de fichie \textsc{fen}, etc.). Une
...
\begin{description}
\item[\meta{str}:] est une chaîne de caractères (netre double-quotes) à afficher.
\item[\meta{pos}:] est une chaîne de caractères (entre double-quotes) consituée d’une coordonnée (lettre et chiffre).
\end{description}
