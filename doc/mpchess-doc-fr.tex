...
\author{Maxime Chupin, \url{mailto:notezik@gmail.com}}
\date{\today}
...
\paragraph{Couleurs.}
Un thème de couleur consiste en la définition de deux couleurs.
...
On pourra aussi récupérer le nombre de coups \og{}total\fg{} au sens où ils sont numérotés dans le format \textsc{pgn}, grâce à la commande suivante :
...
La couleur des annotation de commentaires peut être changée grâce à la commande
suivante.
...
\begin{description}
  ...
  \lstinline"square",\lstinline"disk" and \lstinline"custom"). Coloriage du
  marqueur blanc.
